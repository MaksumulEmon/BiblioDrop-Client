        ...
        <section className="relative py-20 px-5 overflow-hidden">
            ...
            <div className="relative max-w-6xl mx-auto">
                ...
                >
                    ...
                    <span className="inline-block px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs sm:text-sm font-semibold">
                        📚 Join BiblioDrop Today
                    </span>

                    <h2 className="mt-4 sm:mt-6 text-2xl sm:text-3xl md:text-5xl font-extrabold text-white">
                        Ready To Discover
                        <br />
                        Your Next Favorite Book?
                    </h2>

                    <p className="mt-4 sm:mt-6 text-xs sm:text-sm md:text-base text-slate-400 max-w-2xl mx-auto leading-relaxed sm:leading-8">
